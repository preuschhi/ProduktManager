...
public class KundenStrukturen {
	...
	static {
		...
		mapAlleKundenStrukturen.put(alleKunden.kundenSammlungNummer, alleKunden);
	}
	...
	public static class KundenSammlung extends KundenStrukturen {
		/*
		...
		public static KundenSammlung erstelleKundenSammlung(Scanner scanner) {
			/*
			 ...
			 */
			KundenSammlung newKundenSammlung = null;
			do {
				System.out.println(
		...
		public static String setKundenSammlungName(Scanner scanner, boolean testSchleife, String eingabeString) {
			...
			do {
				...
				eingabeString = scanner.nextLine();
				testSchleife = FehlerTest.tryCatchString(eingabeString, false, true);
			} while (testSchleife == true);
	...
	public static class KundenSammlungFunktionen extends KundenStrukturen {
		...
		public static void ausgabeBeliebigeKundenSammlung(Scanner scanner, boolean testSchleife, String eingabeString) {
			/*
			 ...
			 */
			System.out.println("Ausgabe eines Beliebigen Objekts");
			do {
			...
			int kundenSammlungsNummer = Integer.parseInt(eingabeString);
			KundenStrukturen kundenSammlungObjekt = mapAlleKundenStrukturen.get(kundenSammlungsNummer);
		...
		public void kundenZuKundenSammlungHinzufuegen(boolean testSchleife, String eingabeString, Scanner scanner) {
			/*
			...
			if (eingabeString.equals("1")) {
				...
				Kunde newKundeFuerKundenSammlungKunde = Kunde.ErstelleKunde.erstelleKunde(testSchleife, eingabeString,
						scanner);
				super.mapKundenSammlungMap.put(newKundeFuerKundenSammlungKunde.getKundenNummer(),
		...
		public static Kunde nimmBestehendenKunden(boolean testSchleife, String eingabeString, Scanner scanner) {
			...
			for (Integer keyInteger : KundenStrukturen.mapAlleKundenMap.keySet()) {
				System.out.println("Kundennummer: " + keyInteger + " Kundenname: "
						+ KundenStrukturen.mapAlleKundenMap.get(keyInteger));
			}
			do {
		...
		public void loescheKundeAusKundenSammlung(boolean testSchleife, String eingabeString, Scanner scanner) {
			/*
			 ...
			 */
			for (Integer keyInteger : this.mapKundenSammlungMap.keySet()) {
				System.out.println(
						"Kundennummer: " + keyInteger + " Kundenname: " + this.mapKundenSammlungMap.get(keyInteger));
			}
			...
			if (!eingabeString.equals("0")) {
				 ...
				 * geloescht,
				 */
				Iterator<Entry<Integer, Kunde>> iterator = this.mapKundenSammlungMap.entrySet().iterator();
				while (iterator.hasNext()) {
